...
function TasksExampleLogicPage() {
    type ListTaskType = {
        id: string,
        content: string
    }
    ...
    return (
        <main>
            {/* I liked this style below for oppacity changes -->  */}
            <div className="opacity-0 hover:opacity-100 text-center text-gray-400 text-xs mt-2 p-2 border-2 border-dashed border-gray-200 rounded">
                + Add Task
            </div>
            {/*  */}
...
export default TasksExampleLogicPage